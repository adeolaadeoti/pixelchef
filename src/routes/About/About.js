      ...
      <main>
        <section className={style.about__work}>
          <div className={style.about__text}>
            <p>
              We’re a creative team passioned about design, focused on building
              amazing products and brands while turning them into award winning
              projects. We can build things from scratch or simply make them
              look better.
            </p>
          </div>
          <div className={style.about__workWrapper}>
            <div to="/work" className={style.box}>
              ...
              <div>
                <img
                  src={require("../../assets/png/kehinde.png")}
                  alt="kehinde"
                />{" "}
                <span>Big wheel</span>{" "}
              </div>
              <h3 className={style.about__h3}>
                Kehinde Adeyefa -<span>Founder</span>{" "}
              </h3>
            </div>
            <div to="/work" className={style.box}>
              <div>
                <img
                  src={require("../../assets/png/muyiwa.png")}
                  alt="muyiwa"
                />{" "}
                <span>Oshea</span>{" "}
              </div>
              <h3 className={style.about__h3}>
                Muyiwa Babatunde –<br />
                <span>Partner, Product Design</span>{" "}
              </h3>
            </div>
            <div to="/work" className={style.box}>
              <div>
                <img
                  src={require("../../assets/png/mayowa.png")}
                  alt="uLesson"
                />{" "}
                <span>Big man</span>{" "}
              </div>
              <h3 className={style.about__h3}>
                Mayowa Otedola – <br />
                <span>Partner, Design</span>{" "}
              </h3>
            </div>
            <div to="/work" className={style.box}>
              <div>
                <img
                  src={require("../../assets/png/adeola.png")}
                  alt="uLesson"
                />{" "}
                <span>Gegeara</span>{" "}
              </div>
